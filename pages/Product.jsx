...
<div className="hero">
  ...
  <div className="hero-two"><img src="/bmj/eni.png" alt="" className="hr-two-img" /></div>
</div>
...
<section className="cta-section" data-aos="zoom-in">
  <div className="container" style={{maxWidth: '1024px'}}>
    <div className="cta-banner">
      ...
      <button className="btn-hr-one">Book a call</button>
    </div>
  </div>
</section>
...
<section className="testimonials-section section-padding">
  <div className="container" style={{maxWidth: '896px'}} data-aos="fade-up">
    <h2 className="section-title">Client Success = Our Success</h2>
        ...
        >
          <div className="testimonial-card">
            <div className="testimonial-avatar">
              <img src="/bmj/ens.png" alt={testimonial.name} />
            </div>
  ...
  <div className="container">
    <div className="expertise-grid">
      <div className="expertise-content" data-aos="fade-right">
        <h2>Diverse Industry Expertise</h2>
        <p>
          Enomess is proud to serve UK industries, providing tailored solutions
          for many unique business needs. Our expertise spans from eCommerce
          B2B services for online retailers to specialized branding services for
          corporate companies, law firms, and even fintech.
        </p>
      </div>
...
<section className="contact-section section-padding">
  <div className="container">
    <div className="contact-heading text-center" data-aos="fade-up">
      <h2>Ready to Elevate Your Digital Marketing Strategy</h2>
      <p>
        Contact us today to discuss your digital marketing needs and see how
        Enomess can help you convert your business goals.
      </p>
    </div>
    <div className="contact-grid">
      <form className="contact-form" data-aos="fade-right" onSubmit={(e) => e.preventDefault()}>
        ...
        <button type="submit" className="btn-hr-one">Request Now</button>
      </form>
      <div className="contact-image-wrapper" data-aos="fade-left">
        <img src="/bmj/enth.png" alt="Digital marketing tools and concepts" className="contact-image" />
      </div>
    </div>
  </div>
</section>
