...
const About = () => {
  const clientLogos = Array(12).fill("https://picsum.photos/150/75");
  const partnerLogos = Array(10).fill("https://picsum.photos/150/75");
    ...
    <div className="app-container">
      <main>
        ...
        <section className="hero-section">
          ...
          <img src="https://picsum.photos/1600/800?random=1&blur=1" alt="Abstract technology background" className="hero-bg-image" />
                ...
                <div className="clients-grid">
                  {clientLogos.map((logo, index) => (
                    <div key={index} className="client-logo-wrapper">
                      <img src={'eno.png'} alt={`Client logo ${index + 1}`} className="client-logo"/>
                    </div>
                  ))}
                </div>
              </div>
                    ...
                    <div className="partners-grid">
                        {partnerLogos.map((logo, index) => (
                             <div key={index} className="partner-logo-wrapper">
                                <img src={`ent.png`} alt={`Partner logo ${index + 1}`} className="partner-logo"/>
                            </div>
                        ))}
                    </div>
                </AnimatedSection>
              ...
              <div className="get-started-card">
                ...
                <div className="get-started-form">
                    <form className="form">
                        ...
                        <div>
                            <button type="submit" className="btn-vp">
                                Submit Request
                            </button>
                        </div>
                    </form>
