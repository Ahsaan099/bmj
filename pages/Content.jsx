...
const categories = ['All', 'Digital Marketing', 'E-commerce', 'FinStress', 'IT Staff Augmentation', 'Local Resources', 'Mobile App Development', 'Pay2Peer', 'Web Development'];
                    ...
                    <div className="filter-buttons-container" data-aos="fade-up" data-aos-delay="200">
                        {categories.map(category => (
                             <button
                                ...
                                className={`filter-button ${activeCategory === category ? 'active' : 'inactive'}`}
                            >
                                {category}
                            </button>
                        ))}
                    ...
                    <div className="projects-grid">
                        {filteredProjects.map((project, index) => (
                           <div 
                            ...
                            >
                                <div className={`project-card-image-wrapper ${project.bgColor ? project.bgColor : 'bg-gray-100'}`}>
